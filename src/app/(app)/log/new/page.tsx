...
const options = [
  ...
  },
  {
    ...
    description: "Scan a nutrition facts label",
    href: "/log/new/label",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Restaurant",
    description: "Search chain restaurant menus",
    href: "/log/new/restaurant",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Manual Entry",
    description: "Type in nutrition details",
    href: "/log/new/manual",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
